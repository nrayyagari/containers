...
## Context & Problem
This topic explains how boot-time trust influences host integrity for container platforms. In production, this matters because advanced features usually solve a real boundary problem while introducing new operational cost.
...
After that, continue to [gVisor and Kata](../08-gvisor-katata/README.md).
