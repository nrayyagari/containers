...
## Context & Problem
This topic explains how Unix domain sockets support local, secure, low-overhead service communication. In production, this matters because advanced features usually solve a real boundary problem while introducing new operational cost.
...
After that, continue to [Migration To Kubernetes](../../14-migration-to-k8s/README.md).
