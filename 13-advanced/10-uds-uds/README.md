...
## What It Is
Unix Domain Sockets covers How Unix domain sockets support local low-overhead service communication.
...
Then continue to [Migration To Kubernetes](../../14-migration-to-k8s/README.md).
