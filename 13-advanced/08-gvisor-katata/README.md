...
## Context & Problem
This topic explains how sandboxed runtimes trade performance for stronger isolation. In production, this matters because advanced features usually solve a real boundary problem while introducing new operational cost.
...
After that, continue to [Firecracker MicroVMs](../09-firecracker-microvm/README.md).
