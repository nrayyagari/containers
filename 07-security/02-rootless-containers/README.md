...
## What It Is
Rootless Containers covers How to run containers without a privileged daemon or root-owned process.
...
Then continue to [Drop Capabilities](../03-drop-capabilities/README.md).
