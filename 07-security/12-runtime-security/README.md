...
## Context & Problem
This topic explains how to detect and contain malicious or unexpected behavior after a container starts. In production, this matters because container security fails when teams treat one control as sufficient instead of layering identity, policy, and trust.
...
After that, continue to [Registry](../../08-registry/README.md).
