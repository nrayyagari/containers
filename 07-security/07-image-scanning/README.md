...
## Context & Problem
This topic explains how vulnerability scanners inspect image contents and package metadata. In production, this matters because container security fails when teams treat one control as sufficient instead of layering identity, policy, and trust.
...
After that, continue to [Trivy and Snyk](../08-trivy-snyk/README.md).
