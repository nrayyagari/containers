...
## Context & Problem
This topic explains how to remove unnecessary Linux capabilities from a container. In production, this matters because container security fails when teams treat one control as sufficient instead of layering identity, policy, and trust.
...
After that, continue to [Seccomp Profiles](../04-seccomp-profiles/README.md).
