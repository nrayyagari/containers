...
## Context & Problem
This topic explains how AppArmor policies constrain file, network, and capability access. In production, this matters because container security fails when teams treat one control as sufficient instead of layering identity, policy, and trust.
...
After that, continue to [SELinux](../06-selinux/README.md).
