...
## Context & Problem
This topic explains how seccomp profiles control the syscalls a process may use. In production, this matters because container security fails when teams treat one control as sufficient instead of layering identity, policy, and trust.
...
After that, continue to [AppArmor Profiles](../05-apparmor-profiles/README.md).
