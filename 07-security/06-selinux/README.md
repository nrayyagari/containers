...
## Context & Problem
This topic explains how SELinux labels enforce mandatory separation beyond classic Unix permissions. In production, this matters because container security fails when teams treat one control as sufficient instead of layering identity, policy, and trust.
...
After that, continue to [Image Scanning](../07-image-scanning/README.md).
