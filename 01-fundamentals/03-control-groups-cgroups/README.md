...
## Context & Problem
This topic explains how Linux enforces CPU, memory, and I/O boundaries on a group of processes. In production, this matters because every higher-level tool depends on these boundaries behaving exactly as the kernel defines them.
...
After that, continue to [Union Filesystems](../04-union-filesystems/README.md).
