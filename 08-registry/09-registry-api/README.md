...
## Context & Problem
This topic explains what the registry API exposes for manifests, blobs, tags, and catalog operations. In production, this matters because every push and pull is part of your software supply chain, not just a file copy.
...
After that, continue to [Artifact Management](../10-artifact-management/README.md).
