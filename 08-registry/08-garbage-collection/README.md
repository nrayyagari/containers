...
## Context & Problem
This topic explains how registries reclaim unreferenced blobs without breaking clients. In production, this matters because every push and pull is part of your software supply chain, not just a file copy.
...
After that, continue to [Registry Api](../09-registry-api/README.md).
