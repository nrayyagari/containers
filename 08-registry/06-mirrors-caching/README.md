...
## Context & Problem
This topic explains how mirrors reduce latency, rate limits, and upstream dependency. In production, this matters because every push and pull is part of your software supply chain, not just a file copy.
...
After that, continue to [Content Trust](../07-content-trust/README.md).
