...
## Context & Problem
This topic explains how OCI registries store more than container images. In production, this matters because every push and pull is part of your software supply chain, not just a file copy.
...
After that, continue to [Orchestration Basics](../../09-orchestration-basics/README.md).
