...
## Context & Problem
This topic explains how signing and verification fit into registry workflows. In production, this matters because every push and pull is part of your software supply chain, not just a file copy.
...
Early container trust models focused on image signing tied to registry workflows. The industry has since broadened toward OCI-native signatures, attestations, and supply-chain metadata, but the core question is unchanged: how do you know who produced this artifact and whether it changed?
...
After that, continue to [Garbage Collection](../08-garbage-collection/README.md).
