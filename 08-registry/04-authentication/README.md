...
## Context & Problem
This topic explains how registries authorize pull and push actions. In production, this matters because every push and pull is part of your software supply chain, not just a file copy.
...
After that, continue to [Push Pull](../05-push-pull/README.md).
