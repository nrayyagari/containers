...
## Context & Problem
This topic explains how UID, GID, and mode bits determine whether containerized processes can read and write data. In production, this matters because state problems are expensive to recover from and often only show up after restarts, migrations, or outages.
...
After that, continue to [Persistence Strategies](../08-persistence-strategies/README.md).
