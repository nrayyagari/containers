...
## Context & Problem
This topic explains how inode exhaustion breaks containers even when disk space looks available. In production, this matters because state problems are expensive to recover from and often only show up after restarts, migrations, or outages.
...
After that, continue to [Backup Restore](../10-backup-restore/README.md).
