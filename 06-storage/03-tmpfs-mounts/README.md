...
## Context & Problem
This topic explains how in-memory mounts trade durability for speed and cleanliness. In production, this matters because state problems are expensive to recover from and often only show up after restarts, migrations, or outages.
...
After that, continue to [Volume Drivers](../04-volume-drivers/README.md).
