...
## Context & Problem
This topic explains how host paths are mounted directly into containers. In production, this matters because state problems are expensive to recover from and often only show up after restarts, migrations, or outages.
...
After that, continue to [Named Volumes](../02-named-volumes/README.md).
