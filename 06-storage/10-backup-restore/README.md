...
## Context & Problem
This topic explains how to protect and restore container data without corrupting live workloads. In production, this matters because state problems are expensive to recover from and often only show up after restarts, migrations, or outages.
...
After that, continue to [Security](../../07-security/README.md).
