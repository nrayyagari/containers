...
## Context & Problem
This topic explains how external plugins extend Docker volume backends. In production, this matters because state problems are expensive to recover from and often only show up after restarts, migrations, or outages.
...
After that, continue to [Storage Drivers Overlay](../05-storage-drivers-overlay/README.md).
