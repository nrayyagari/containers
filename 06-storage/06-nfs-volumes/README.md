...
## Context & Problem
This topic explains how network filesystems enable shared data across hosts. In production, this matters because state problems are expensive to recover from and often only show up after restarts, migrations, or outages.
...
After that, continue to [Volume Permissions](../07-volume-permissions/README.md).
