...
## What It Is
Minimal Base Images covers When slim, distroless, or scratch images are the right trade-off.
...
Then continue to [Ci Cd Integration](../10-ci-cd-integration/README.md).
