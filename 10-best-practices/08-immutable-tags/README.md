...
## Context & Problem
This topic explains why mutable tags such as latest create ambiguity in deployments. In production, this matters because small shortcuts here create recurring reliability, security, and rollout problems later.
...
After that, continue to [Minimal Base Images](../09-minimal-base-images/README.md).
