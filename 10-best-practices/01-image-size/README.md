...
## Context & Problem
This topic explains why smaller images improve transfer time, startup speed, attack surface, and cache efficiency. In production, this matters because small shortcuts here create recurring reliability, security, and rollout problems later.
...
After that, continue to [Layer Optimization](../02-layer-optimization/README.md).
