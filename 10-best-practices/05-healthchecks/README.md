...
## Context & Problem
This topic explains how to signal application health accurately without causing restart storms. In production, this matters because small shortcuts here create recurring reliability, security, and rollout problems later.
...
After that, continue to [Logging](../06-logging/README.md).
