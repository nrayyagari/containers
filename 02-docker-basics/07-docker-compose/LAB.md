...
## Goal
Develop hands-on confidence for Docker Compose and prove understanding through observable output.
...
- Which validation step should run before merging compose changes?
