...
## Context & Problem
This topic explains why shims sit between the runtime manager and individual containers. In production, this matters because runtime-layer confusion leads engineers to inspect or restart the wrong component.
...
- Which process evidence in this lab confirms shim responsibility?
- What symptom suggests shim-level failure rather than app crash?

## Next Steps
Run [LAB.md](./LAB.md) and do not mark it complete until you can explain both the mechanism and the failure mode.
After that, continue to [OCI Specifications](../09-oci-spec/README.md).
