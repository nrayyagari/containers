...
## What It Is
CRI-O covers How CRI-O provides a Kubernetes-focused runtime implementation.
...
## Lab Focus
Use the lab to prove how CRI-O provides a Kubernetes-focused runtime implementation.
- Key commands:
...
Then continue to [Docker vs containerd](../05-docker-vs-containerd/README.md).
