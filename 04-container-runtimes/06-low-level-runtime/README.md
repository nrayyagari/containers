...
## Context & Problem
This topic explains what low-level runtimes do versus higher-level managers. In production, this matters because runtime-layer confusion leads engineers to inspect or restart the wrong component.
...
After that, continue to [High Level Runtime](../07-high-level-runtime/README.md).
