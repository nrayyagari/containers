...
## What It Is
OCI Specifications covers How OCI specs standardize image and runtime behavior.
...
## Lab Focus
Use the lab to prove how OCI specs standardize image and runtime behavior.
- Key commands:
...
Then continue to [RuntimeClass](../10-runtime-classes/README.md).
