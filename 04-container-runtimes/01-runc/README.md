...
## Context & Problem
This topic explains how the low-level OCI runtime creates the container process from a bundle. In production, this matters because runtime-layer confusion leads engineers to inspect or restart the wrong component.
...
After that, continue to [Containerd](../02-containerd/README.md).
