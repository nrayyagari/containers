...
## What It Is
Runc covers How the low-level OCI runtime creates the container process.
...
## Lab Focus
Use the lab to prove how the low-level OCI runtime creates the container process.
- Key commands:
...
Then continue to [Containerd](../02-containerd/README.md).
