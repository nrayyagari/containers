...
## Context & Problem
This topic is part of 04-container-runtimes and explains an essential concept required for production container operations.
...
- What it is:
  - Docker Vs Containerd as a practical container concept.
- What it is not:
