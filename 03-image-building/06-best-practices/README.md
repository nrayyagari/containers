...
## Context & Problem
This topic explains how to build images that are small, reproducible, secure, and maintainable. In production, this matters because the image you build becomes the artifact every runtime and every rollback depends on.
...
After that, continue to [Registries](../07-registries/README.md).
