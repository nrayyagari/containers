...
## What It Is
Tags covers How tag strategy affects traceability and rollback safety.
...
## Lab Focus
Use the lab to prove how tag strategy affects traceability and rollback safety.
- Key commands:
...
Then continue to [Build Arguments](../09-build-arguments/README.md).
