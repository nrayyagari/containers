...
## What It Is
Base Images covers How base image choice changes size, compatibility, and attack surface.
...
## Lab Focus
Use the lab to prove how base image choice changes size, compatibility, and attack surface.
- Key commands:
...
Then continue to [Best Practices](../06-best-practices/README.md).
