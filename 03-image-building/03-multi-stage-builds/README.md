...
## What It Is
Multi Stage Builds covers How to split build and runtime stages to reduce size and risk.
...
## Lab Focus
Use the lab to prove how to split build and runtime stages to reduce size and risk.
- Key commands:
...
Then continue to [Layer Caching](../04-layer-caching/README.md).
