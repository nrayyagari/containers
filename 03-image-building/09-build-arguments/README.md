...
## What It Is
Build Arguments covers How ARG values affect a build without becoming runtime environment variables.
...
## Lab Focus
Use the lab to prove how ARG values affect a build without becoming runtime environment variables.
- Key commands:
...
Then continue to [Build Secrets](../10-build-secrets/README.md).
