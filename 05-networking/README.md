...
- [02-host-networking](./02-host-networking/README.md): what changes when a container shares the host network stack.
- [03-overlay-networking](./03-overlay-networking/README.md): how overlay networks carry container traffic across hosts.
- [04-macvlan-ipvlan](./04-macvlan-ipvlan/README.md): how containers get more direct network identity on the physical network.
- [05-dns-service-discovery](./05-dns-service-discovery/README.md): how containers resolve service names and where DNS failures hide.
...
- [09-iptables-rules](./09-iptables-rules/README.md): how iptables implements forwarding and NAT for containers.
