...
## Context & Problem
This topic explains what docker-proxy does and when kernel NAT can replace it. In production, this matters because most container network incidents are really packet-path or name-resolution problems hidden by abstraction.
...
After that, continue to [Iptables Rules](../09-iptables-rules/README.md).
