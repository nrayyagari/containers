...
## Context & Problem
This topic explains how packet filtering and NAT rules implement container connectivity. In production, this matters because most container network incidents are really packet-path or name-resolution problems hidden by abstraction.
...
After that, continue to [IPv6](../10-ipv6/README.md).
