...
## Context & Problem
This topic explains how the default bridge model connects containers through a Linux bridge and NAT. In production, this matters because most container network incidents are really packet-path or name-resolution problems hidden by abstraction.
...
After that, continue to [Host Networking](../02-host-networking/README.md).
