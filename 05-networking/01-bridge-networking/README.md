...
## What It Is
Bridge Networking covers How the default bridge model connects containers through a Linux bridge and NAT.
...
Then continue to [Host Networking](../02-host-networking/README.md).
