...
## Context & Problem
This topic explains what happens when a container shares the host network stack. In production, this matters because most container network incidents are really packet-path or name-resolution problems hidden by abstraction.
Host networking removes a layer of isolation. It does not automatically make architecture or performance better.
...
After that, continue to [Overlay Networking](../03-overlay-networking/README.md).
