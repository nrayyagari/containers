...
## Context & Problem
This topic explains what changes when containers participate in IPv6 networks. In production, this matters because most container network incidents are really packet-path or name-resolution problems hidden by abstraction.
...
After that, continue to [Storage](../../06-storage/README.md).
