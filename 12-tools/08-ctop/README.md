...
## Context & Problem
This topic explains how ctop gives a live top-like view of running containers. In production, this matters because tool choice determines which layer you can actually observe and which assumptions remain hidden.
...
After that, continue to [Dive](../09-dive/README.md).
