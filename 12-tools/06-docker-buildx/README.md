...
## Context & Problem
This topic explains how Buildx unlocks BuildKit, multi-platform builds, and advanced caching. In production, this matters because tool choice determines which layer you can actually observe and which assumptions remain hidden.
...
After that, continue to [Kompose](../07-kompose/README.md).
