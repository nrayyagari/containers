...
## Context & Problem
This topic explains how Kompose translates Compose definitions into Kubernetes manifests. In production, this matters because tool choice determines which layer you can actually observe and which assumptions remain hidden.
...
After that, continue to [ctop](../08-ctop/README.md).
