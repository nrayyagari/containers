...
## Context & Problem
This topic explains how nerdctl exposes containerd features with familiar CLI semantics. In production, this matters because tool choice determines which layer you can actually observe and which assumptions remain hidden.
...
After that, continue to [crictl](../04-crictl/README.md).
