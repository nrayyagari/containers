...
## Context & Problem
This topic explains what CPU, memory, and process views tell you during a live incident. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Sysdig and Falco](../14-sysdig-falco/README.md).
