...
## Context & Problem
This topic explains how to diagnose OOM kills, CPU throttling, and pressure-related slowdowns. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Process Analysis](../05-process-analysis/README.md).
