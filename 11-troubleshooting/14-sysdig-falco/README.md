...
## Context & Problem
This topic explains how system call monitoring and rules detect suspicious runtime behavior. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Prometheus Metrics](../15-prometheus-metrics/README.md).
