...
## Context & Problem
This topic explains how to narrow connectivity problems to DNS, routing, firewall, or application behavior. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Resource Issues](../04-resource-issues/README.md).
