...
## Context & Problem
This topic explains how to reclaim space safely without deleting required artifacts. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Tools](../../12-tools/README.md).
