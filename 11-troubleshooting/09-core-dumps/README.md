...
## Context & Problem
This topic explains how to capture crash data without losing containment or filling disks. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Dive, ctop, and Sysdig](../10-tools-dive-ctop-sysdig/README.md).
