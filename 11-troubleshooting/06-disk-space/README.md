...
## Context & Problem
This topic explains how image layers, writable layers, and volumes consume host storage. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Dns Issues](../07-dns-issues/README.md).
