...
## Context & Problem
This topic explains how time-series metrics complement point-in-time shell debugging. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Crictl Debug](../16-crictl-debug/README.md).
