...
## Context & Problem
This topic explains how packet capture proves where traffic is lost or transformed. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [htop and top](../13-htop-top/README.md).
