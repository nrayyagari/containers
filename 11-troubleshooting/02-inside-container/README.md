...
## Context & Problem
This topic explains how to inspect a container process, filesystem, and namespace state safely. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Network Debugging](../03-network-debugging/README.md).
