...
## What It Is
Nerdctl Debug covers How to debug containerd-managed workloads with a Docker-like CLI.
...
Then continue to [Dive Image Analysis](../18-dive-image-analysis/README.md).
