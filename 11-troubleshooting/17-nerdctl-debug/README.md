...
## Context & Problem
This topic explains how to debug containerd-managed workloads with a Docker-like CLI. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Dive Image Analysis](../18-dive-image-analysis/README.md).
