...
## Context & Problem
This topic explains how to understand process trees, parents, and signals inside containers. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Disk Space](../06-disk-space/README.md).
