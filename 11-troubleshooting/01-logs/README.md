...
## Context & Problem
This topic explains how to use stdout and stderr, container logs, and engine logs as the first evidence stream. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [Inside Container](../02-inside-container/README.md).
