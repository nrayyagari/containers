...
## Context & Problem
This topic explains how syscall and library-call tracing expose hidden runtime failures. In production, this matters because fast recovery depends on collecting the right evidence before changing the system.
...
After that, continue to [tcpdump and Wireshark](../12-tcpdump-wireshark/README.md).
