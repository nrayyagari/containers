...
## Context & Problem
This topic explains how runtime configuration is injected without rebuilding images. In production, this matters because once workloads become scheduled and replicated, host-centric mental models stop working.
...
After that, continue to [Scheduling](../09-scheduling/README.md).
