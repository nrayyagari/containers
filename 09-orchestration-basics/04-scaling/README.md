...
## Context & Problem
This topic explains how systems add or remove replicas in response to demand or policy. In production, this matters because once workloads become scheduled and replicated, host-centric mental models stop working.
...
After that, continue to [Health Checks](../05-health-checks/README.md).
