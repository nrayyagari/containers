...
## Context & Problem
This topic explains why schedulers exist once containers outgrow manual host-by-host management. In production, this matters because once workloads become scheduled and replicated, host-centric mental models stop working.
Orchestration is not just 'running many containers.' It is the control logic that keeps desired and actual state aligned.
...
After that, continue to [Service Discovery](../02-service-discovery/README.md).
