...
## What It Is
What Is Orchestration? covers Why schedulers exist once containers outgrow manual host-by-host management.
...
Then continue to [Service Discovery](../02-service-discovery/README.md).
