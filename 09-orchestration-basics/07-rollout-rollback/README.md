...
## Context & Problem
This topic explains how new versions are introduced and reversed without full outages. In production, this matters because once workloads become scheduled and replicated, host-centric mental models stop working.
...
After that, continue to [Config Management](../08-config-management/README.md).
