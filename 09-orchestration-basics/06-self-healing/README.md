...
## Context & Problem
This topic explains how orchestration loops replace failed tasks and converge back to desired state. In production, this matters because once workloads become scheduled and replicated, host-centric mental models stop working.
...
After that, continue to [Rollout Rollback](../07-rollout-rollback/README.md).
