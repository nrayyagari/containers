...
## What It Is
Self Healing covers How control loops replace failed tasks and converge back to desired state.
...
Then continue to [Rollout Rollback](../07-rollout-rollback/README.md).
