...
## Context & Problem
This topic explains how platforms distinguish a started container from a usable service. In production, this matters because once workloads become scheduled and replicated, host-centric mental models stop working.
...
After that, continue to [Self Healing](../06-self-healing/README.md).
